...
import '../../app/model/key_value.dart';
import '../../app/widgets/key_value_sheet.dart';

Future<T?> openAppBottomSheet<T>(Widget page, {bool isDismissible = true}) async => await Get.bottomSheet(
    ClipRRect(
    ...
    shape: const RoundedRectangleBorder(borderRadius: BorderRadius.only(topRight: Radius.circular(12), topLeft: Radius.circular(12))),
      ...
      builder: (context, scrollController) {
        return Container(
          decoration: BoxDecoration(
            color: Get.isDarkMode ? Colors.white : Theme.of(context).scaffoldBackgroundColor,
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                height: 4,
                margin: EdgeInsets.symmetric(vertical: context.deviceSize.height * .015, horizontal: context.deviceSize.width * .4),
